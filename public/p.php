...
// FuelPHP like customize
error_reporting(-1);
ini_set('display_errors', 1);
define('DOCROOT', __DIR__.DIRECTORY_SEPARATOR);
define('APPPATH', realpath(__DIR__.'/../fuel/app/').DIRECTORY_SEPARATOR);
$env = (isset($_SERVER['FUEL_ENV']) ? $_SERVER['FUEL_ENV'] : 'development');
$piwik = array_merge(include(APPPATH.'config/piwik.php'), include(APPPATH.'config/'.$env.'/piwik.php'));
