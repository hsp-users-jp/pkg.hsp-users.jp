...
<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
	...
	<div class="hidden form-group <?php echo Arr::get($state,'title') ?>" data-from-toggle="1">
	...
	<div class="hidden form-group <?php echo Arr::get($state,'description') ?>" data-from-toggle="1">
...
※ HTMLタグは使用できません。
	...
	<div class="hidden form-group <?php echo Arr::get($state,'url') ?>" data-from-toggle="1">
	...
	<div class="hidden form-group <?php echo Arr::get($state,'package_type') ?>" data-from-toggle="1">
...
?>
	...
	<div class="hidden form-group <?php echo Arr::get($state,'license') ?>" data-from-toggle="1">
	...
	<div class="hidden form-group" data-from-toggle="1">
